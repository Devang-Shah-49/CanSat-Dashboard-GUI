...
int packet_count = 1;
char Packet_Type[5] = "CT"; // Container = 0 ; Tethered_payload = 1;
...
{  
  ...
  if(Serial.available() > 0) {
    ...
    if(command.charAt(0) == '1')
      ...
      Cmd_Echo = "3-" + command.substring(2);
      ...
      Cmd_Echo = "7";
    else if(command.charAt(0) == '8')
      Cmd_Echo = "8";
    else if(command.charAt(0) == '9')
      Cmd_Echo = "9-" + command.substring(2);
  }
  delay(1000);
}
